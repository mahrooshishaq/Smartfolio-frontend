...
export default function BrandMark({
  ...
  return (
    ...
    >
      ...
      <circle cx="43" cy="21" r="8" fill="none" stroke="#34d399" strokeOpacity="0.28" strokeWidth="2.4" />
      <path
      ...
      <circle cx="27.5" cy="36" r="4" fill="#fbbf24" />
      <circle cx="43" cy="21" r="5.5" fill="#34d399" />
      <path
