...
#foli-boot{position:fixed;inset:0;z-index:9998;display:none;place-items:center;
  background:linear-gradient(160deg,#f5effb,#fbf6fc 45%,#faedf5);
  font-family:ui-sans-serif,system-ui,-apple-system,"Segoe UI",Roboto,sans-serif}
#foli-boot .fb-in{display:flex;flex-direction:column;align-items:center;gap:2px;text-align:center}
#foli-boot svg{width:104px;height:104px;overflow:visible;animation:fb-bob 2.1s ease-in-out infinite}
...
#foli-boot .fb-bar{width:120px;height:4px;border-radius:99px;background:rgba(207,159,255,.18);overflow:hidden;margin-top:13px}
#foli-boot .fb-bar>span{display:block;height:100%;width:40%;border-radius:99px;
  background:linear-gradient(90deg,#5D3FD3 0%,#5D3FD3 32%,#BF40BF 48%,#CF9FFF 64%,#CF9FFF 100%);animation:fb-sl 1.1s ease-in-out infinite}
...
<linearGradient id="fbLine" x1="0" y1="1" x2="1" y2="0"><stop offset="0" stop-color="#5D3FD3"/><stop offset=".32" stop-color="#5D3FD3"/><stop offset=".48" stop-color="#BF40BF"/><stop offset=".64" stop-color="#CF9FFF"/><stop offset="1" stop-color="#CF9FFF"/></linearGradient>
</defs>
...
<path d="M128 26 L164 62 L128 62 Z" fill="#f0e4ff"/>
<path d="M150 40 L154 52 L166 56 L154 60 L150 72 L146 60 L134 56 L146 52 Z" fill="url(#fbLine)"/>
<rect x="66" y="72" width="20" height="5" rx="2.5" fill="#5D3FD3"/><rect x="114" y="72" width="20" height="5" rx="2.5" fill="#5D3FD3"/>
...
<circle cx="78" cy="92" r="6" fill="#5D3FD3"/><circle cx="122" cy="92" r="6" fill="#5D3FD3"/>
<circle cx="81" cy="89" r="2" fill="#fff"/><circle cx="125" cy="89" r="2" fill="#fff"/>
<path d="M88 118 Q100 126 112 118" fill="none" stroke="#5D3FD3" stroke-width="5" stroke-linecap="round"/>
<circle cx="52" cy="150" r="15" fill="#f1e7f7" stroke="#e4d5ed" stroke-width="2"/><circle cx="148" cy="150" r="15" fill="#f1e7f7" stroke="#e4d5ed" stroke-width="2"/>
</svg>
