...
function EntryCard({ children, onRemove }: { children: React.ReactNode; onRemove: () => void }) { return <div className="relative rounded-2xl border border-slate-100 p-4"><button onClick={onRemove} className="absolute right-3 top-3 rounded-lg p-1.5 text-slate-500 hover:bg-red-50 hover:text-red-500"><Trash2 size={14} /></button><div className="space-y-3 pr-8">{children}</div></div>; }
